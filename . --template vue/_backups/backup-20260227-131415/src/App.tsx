  ...
  return (
    <div style={pageStyle} className="quote-page">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '0.9fr 1.4fr', gap: 20 }}>
        <div style={panelStyle} className="panel glass-card">
...
function App() {
  ...
  return (
    <div className="app-root theme-classic" style={{ minHeight: '100vh', backgroundColor: '#0b0f1a', color: '#e5e7eb' }}>
      <div style={{ maxWidth: 1600, margin: '0 auto', padding: 20 }}>
        <div className="nav-glass" style={{ display: 'flex', marginBottom: 16 }}>
          <button
        ...
        {activeTab === 'quoter' ? <div className="quote-page"><Quoter /></div> : <div className="admin-page"><Admin /></div>}
      </div>
    </div>
  )
}
